...
//        progressDialog.setMessage("no sush user...");
//        progressDialog.show();
...
//                Toast.makeText(getApplicationContext(), Backendless.UserService.CurrentUser().getEmail(), Toast.LENGTH_SHORT).show();
//
...
//                Toast.makeText(getApplicationContext(), _emailText.getText().toString(), Toast.LENGTH_SHORT).show();
